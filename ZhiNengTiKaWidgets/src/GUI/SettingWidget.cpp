    ...
    : QWidget{ parent }
{
    ...
    connect(this->userListComboBox, &QComboBox::currentIndexChanged, this, [this](int index)
            {
                if(index > 0)
                {
    ...
    connect(this->loginButton, &QPushButton::clicked, this, [this]
            {
                QDialog dialog(this);
                ...
                connect(&OKButton, &QPushButton::clicked, this, [&usernameLineEdit, &passwordLineEdit, &OKButton, this, &dialog]
                        {
    ...
    connect(this->logoutButton, &QPushButton::clicked, this, [this]
            {
                settings->getAccountManager()->logout();
                QMessageBox::information(this, QStringLiteral("information"), QStringLiteral("登出成功"));
                setUserList(); });

    connect(fontComboBox, &QComboBox::currentTextChanged, this, [this](const QString &text)
            {
    ...
    connect(fontPointSizeSpinBox, &QSpinBox::valueChanged, this, [this](int i)
            {
    ...
    connect(this->commonProblemButton, &QPushButton::clicked, this, [this]
            { QMessageBox::about(this, QStringLiteral("常见问题"), QStringLiteral("<h4>1.如何使用</h4>"
                                                                                  ...
                                                                                  "<p>可以获取软件未收录的题卡</p>"
                                                                                  "<p>也可以上传作业</p>")); });
    connect(this->knownProblemButton, &QPushButton::clicked, this, [this]
            { QMessageBox::about(this, QStringLiteral("已知问题"),
                                 QStringLiteral("<h3>Qt框架的BUG:</h3>"
                                                "<h4>1.公式显示有问题</h4>"
                                                "<h4>2.正常退出软件后, 立刻再次启动会闪退</h4>")); });
    connect(this->aboutButton, &QPushButton::clicked, this, [this]
    ...
    connect(this->usedSourceButton, &QPushButton::clicked, this, [this]
    ...
    connect(this->openSourceLicenseButton, &QPushButton::clicked, this, [this]
    ...
    connect(this->aboutQtButton, &QPushButton::clicked, this, [this]
            { QMessageBox::aboutQt(this); });
    connect(this->cleanTempButton, &QPushButton::clicked, this, [this]
            {
...
void SettingWidget::setUserList()
{
    ...
    {
        for (const auto &i : settings->getAccountManager()->getUserDatas())
        {
